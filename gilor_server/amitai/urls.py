...
from .views import api_home, snake, save_score, adding_data, create_data, get_all_templates, delete_all_templates, madlibs_game, get_finished_template_by_id, get_finished_data, create_finished_data, get_random_template, delete_data, update_data
