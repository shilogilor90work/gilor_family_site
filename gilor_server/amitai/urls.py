...
from .views import api_home, snake, save_score, adding_data, create_data, read_data, delete_all_templates, madlibs_game, read_finished_data, create_finished_data#, delete_data, update_data
